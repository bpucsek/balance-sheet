module.exports = {
  ...
  "rules": {
    ...
    "no-console": ["error", { allow: ["warn", "error", "log", "time", "timeEnd"] }], // disallow use of console (off by default in the node environment)
    ...
    "one-var": [0, "consecutive"], // allow just one var statement per function (off by default)
